  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        // Step 3: Add quotes to unquoted keys (key: or key ,)
        // Match word characters followed by : or ,
        rawText = rawText.replace(/([a-zA-Z_][a-zA-Z0-9_]*)\s*:/g, '"$1":');
        ...
        setFileError(
          `Fichier JSON invalide: ${err.message || "erreur de syntaxe"}`,
        );
        setConfig(null);
      }
    };
